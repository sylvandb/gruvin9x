...
bool check(uint8_t event, uint8_t curr, MenuFuncP *menuTab, uint8_t menuTabSize, pm_uint8_t *subTab, uint8_t subTabMax, uint8_t maxrow);
...
TITLE(title); \
static pm_uint8_t mstate_tab[] = __VA_ARGS__; \
