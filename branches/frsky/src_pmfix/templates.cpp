...
const char stn1[] =  "Simple 4-CH";
const char stn2[] =  "T-Cut";
const char stn3[] =  "V-Tail";
const char stn4[] =  "Elevon\\Delta";
const char stn5[] =  "eCCPM";
const char stn6[] =  "Heli Setup";
const char stn7[] =  "Servo Test";
const pm_char* n_Templates[] PROGMEM = 
{
  stn1,
  stn2,
  stn3,
...
const pm_int8_t heli_ar1[] = {-100, 20, 50, 70, 90};
